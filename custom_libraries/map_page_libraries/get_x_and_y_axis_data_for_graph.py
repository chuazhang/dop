...
#database libraries
from create_and_migrate_db import Pad_Forecasted_Volumes_Tables_Class, Cell_Id_And_Capacity_Table_Class
...
def Get_X_And_Y_Axis_Data_For_Graph():
    ...
    for specific_cell_db_object in specific_cell_database_objects:
        ...
        produced_gas_y_axis_data_list.append(specific_cell_db_object.produced_gas)
        ...
        produced_oil_for_this_date=specific_cell_db_object.produced_oil
        produced_water_for_this_date=specific_cell_db_object.produced_water
