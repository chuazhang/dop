...
#custom libraries
from custom_libraries.map_page_libraries.get_cpf_x_and_y_axis_data_for_graph import Get_CPF_X_And_Y_Axis_Data_For_Graph
 

def Create_CPF_Graph():
    # Create figure with secondary y-axis
    fig = make_subplots(specs=[[{"secondary_y": True}]])

    # Grab the x and y axis data
    dict_of_x_and_y_axis_data_for_graph=Get_CPF_X_And_Y_Axis_Data_For_Graph()
    ...
    #save the figure
    cpf_graph_div_data=ply.plot(fig, include_plotlyjs=False, output_type='div')
    return cpf_graph_div_data
    #ply.plot(fig,filename="templates/home_page/map_page_modals/cpf_modal/graphs/updated_graph.html",output_type="div", auto_open=False)